deps_config := \
	...
	drivers/media/platform/img/e5010/Kconfig \
	drivers/media/platform/img/Kconfig \
...
ifneq "$(KERNELVERSION)" "6.1.46"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "arm-oe-linux-gnueabi-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "arm-oe-linux-gnueabi-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "arm-oe-linux-gnueabi-gcc (GCC) 11.4.0"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "arm-oe-linux-gnueabi-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "arm-oe-linux-gnueabi-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
...
ifneq "$(AR)" "arm-oe-linux-gnueabi-ar"
include/config/auto.conf: FORCE
endif
