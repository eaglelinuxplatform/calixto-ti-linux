...
SYMBOL_CRC(ip6t_do_table, 0x2e5ab50e, "");
SYMBOL_CRC(ip6t_register_table, 0xfd8b967c, "");
SYMBOL_CRC(ip6t_unregister_table_exit, 0xafc03235, "");
SYMBOL_CRC(ip6t_unregister_table_pre_exit, 0x01b91dae, "");
SYMBOL_CRC(ip6t_alloc_initial_table, 0x89a21084, "_gpl");
