...
$(deps_net/core/sock.o):
#SYMVER sk_ns_capable 0x043430d6
#SYMVER sk_capable 0xbbf7c6bb
#SYMVER sk_net_capable 0xcf9b1dcf
#SYMVER sysctl_wmem_max 0xfac8865f
#SYMVER sysctl_rmem_max 0xb05fc310
#SYMVER sysctl_optmem_max 0xa108eb4d
#SYMVER memalloc_socks_key 0x06b53bd2
#SYMVER sk_set_memalloc 0xa64a1739
#SYMVER sk_clear_memalloc 0x3c829293
#SYMVER __sk_backlog_rcv 0x051b79a7
#SYMVER sk_error_report 0x8f61f245
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0xcfc8c3f6
#SYMVER sock_queue_rcv_skb_reason 0xf143e50f
#SYMVER __sk_receive_skb 0x48f5a611
#SYMVER __sk_dst_check 0x058c2b00
#SYMVER sk_dst_check 0x6298048a
#SYMVER sock_bindtoindex 0xdb5664d4
#SYMVER sk_mc_loop 0x3f7fc5ec
#SYMVER sock_set_reuseaddr 0x6d810d1d
#SYMVER sock_set_reuseport 0xc8853cab
#SYMVER sock_no_linger 0x006d0352
#SYMVER sock_set_priority 0x44ff3680
#SYMVER sock_set_sndtimeo 0x2036d334
#SYMVER sock_enable_timestamps 0xd83fc458
#SYMVER sock_set_keepalive 0xeccca5ba
#SYMVER sock_set_rcvbuf 0xc1ff4e20
#SYMVER sock_set_mark 0xd227f692
#SYMVER sockopt_lock_sock 0xb3fe80cf
#SYMVER sockopt_release_sock 0x0109a770
#SYMVER sockopt_ns_capable 0x884dbae9
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0x9946b9a4
#SYMVER sk_alloc 0xfd80fc97
#SYMVER sk_free 0x5625faaa
#SYMVER sk_clone_lock 0xb427e1ce
#SYMVER sk_free_unlock_clone 0x2cffbd2d
#SYMVER sk_setup_caps 0xb409700b
#SYMVER sock_wfree 0x0b47a1c5
#SYMVER skb_set_owner_w 0x37ba4336
#SYMVER skb_orphan_partial 0xdb1f15f0
#SYMVER sock_rfree 0x0ed0858a
#SYMVER sock_efree 0x1bfef773
#SYMVER sock_pfree 0xba5cc533
#SYMVER sock_i_uid 0x1638c53f
#SYMVER __sock_i_ino 0x1c8687de
#SYMVER sock_i_ino 0x3fbfd9c1
#SYMVER sock_wmalloc 0x0eee0c09
#SYMVER sock_kmalloc 0x8d27c8a0
#SYMVER sock_kfree_s 0xf249f21c
#SYMVER sock_kzfree_s 0x74d5b8ad
#SYMVER sock_alloc_send_pskb 0x1a928ba4
#SYMVER __sock_cmsg_send 0xae285d79
#SYMVER sock_cmsg_send 0xa37377f0
#SYMVER skb_page_frag_refill 0x0c499e51
#SYMVER sk_page_frag_refill 0xb1320884
#SYMVER __sk_flush_backlog 0x1e18c1ca
#SYMVER sk_wait_data 0x2902fd0b
#SYMVER __sk_mem_schedule 0xf815f0a4
#SYMVER __sk_mem_reclaim 0x68dc7829
#SYMVER sk_set_peek_off 0x5f52d565
#SYMVER sock_no_bind 0xc08e7dfc
#SYMVER sock_no_connect 0x24d5c01a
#SYMVER sock_no_socketpair 0xacda4cfa
#SYMVER sock_no_accept 0x29bdd98c
#SYMVER sock_no_getname 0x027faf67
#SYMVER sock_no_ioctl 0x07a240ee
#SYMVER sock_no_listen 0x1ec311ca
#SYMVER sock_no_shutdown 0x596b39fb
#SYMVER sock_no_sendmsg 0x5ea40bcf
#SYMVER sock_no_sendmsg_locked 0xb07eff67
#SYMVER sock_no_recvmsg 0x462add47
#SYMVER sock_no_mmap 0x679374a4
#SYMVER sock_no_sendpage 0xc7827b8f
#SYMVER sock_no_sendpage_locked 0xe47cc202
#SYMVER sk_send_sigurg 0xecb54ef1
#SYMVER sk_reset_timer 0x2366935b
#SYMVER sk_stop_timer 0xa5dec62f
#SYMVER sk_stop_timer_sync 0xf6f022af
#SYMVER sock_init_data_uid 0x2bad487e
#SYMVER sock_init_data 0x7b7a1604
#SYMVER lock_sock_nested 0xb020a468
#SYMVER release_sock 0x7b629328
#SYMVER __lock_sock_fast 0xec1e348d
#SYMVER sock_gettstamp 0xb12ab068
#SYMVER sock_recv_errqueue 0x9f37c57d
#SYMVER sock_common_getsockopt 0x5c6d77ac
#SYMVER sock_common_recvmsg 0x45abdd7b
#SYMVER sock_common_setsockopt 0x3c1417d0
#SYMVER sk_common_release 0xd8d8000e
#SYMVER sock_prot_inuse_get 0x67a64df7
#SYMVER sock_inuse_get 0x48ce84d2
#SYMVER proto_register 0xa1861658
#SYMVER proto_unregister 0xd87b182a
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0x2ff62cfc
