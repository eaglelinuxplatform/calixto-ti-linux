...
$(deps_fs/posix_acl.o):
#SYMVER get_cached_acl 0x4fb714a7
#SYMVER get_cached_acl_rcu 0x9d720ff2
#SYMVER set_cached_acl 0xe1eb7c17
#SYMVER forget_cached_acl 0xf4bbcca8
#SYMVER forget_all_cached_acls 0xc240fe73
#SYMVER get_acl 0xfebfaef1
#SYMVER posix_acl_init 0xbf59c419
#SYMVER posix_acl_alloc 0x9b496b21
#SYMVER posix_acl_clone 0xfb60faf5
#SYMVER posix_acl_valid 0xf2f2924f
...
#SYMVER posix_acl_chmod 0xf7dd75d9
#SYMVER posix_acl_create 0x32a2e2d7
#SYMVER posix_acl_update_mode 0x7c591e41
#SYMVER vfs_set_acl_prepare 0x1b58acdf
#SYMVER posix_acl_from_xattr 0x0c1cdc75
#SYMVER posix_acl_to_xattr 0x8c68a22a
#SYMVER set_posix_acl 0x88f7352e
#SYMVER posix_acl_access_xattr_handler 0x4df473ea
#SYMVER posix_acl_default_xattr_handler 0xbaad97d3
