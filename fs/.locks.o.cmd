...
$(deps_fs/locks.o):
#SYMVER locks_alloc_lock 0x949feb7b
#SYMVER locks_release_private 0xacacb7c0
#SYMVER locks_owner_has_blockers 0xba35869c
#SYMVER locks_free_lock 0xd49d8df7
#SYMVER locks_init_lock 0x560811b1
#SYMVER locks_copy_conflock 0x3c1c8b72
#SYMVER locks_copy_lock 0xcc961538
#SYMVER locks_delete_block 0x22f6a282
#SYMVER posix_test_lock 0xc1ed5dfa
#SYMVER posix_lock_file 0x9964cb06
#SYMVER lease_modify 0x9ba3c419
#SYMVER __break_lease 0x7ffa3f98
#SYMVER lease_get_mtime 0x1000d17c
#SYMVER generic_setlease 0x96f39bf5
#SYMVER lease_register_notifier 0x43aa319e
#SYMVER lease_unregister_notifier 0x985453e1
#SYMVER vfs_setlease 0x2bfab76c
#SYMVER locks_lock_inode_wait 0x4d4b5d21
#SYMVER vfs_test_lock 0xd8c9b5a0
#SYMVER vfs_lock_file 0x8d483131
#SYMVER locks_remove_posix 0x7d73fb31
#SYMVER vfs_cancel_lock 0xe741dcfc
#SYMVER vfs_inode_has_locks 0x28cb5781
