...
$(deps_mm/filemap.o):
#SYMVER filemap_check_errors 0x4b49a516
#SYMVER filemap_fdatawrite_wbc 0x547f3fe2
#SYMVER filemap_fdatawrite 0x181050fb
#SYMVER filemap_fdatawrite_range 0xebf5fc94
#SYMVER filemap_flush 0x881aa962
#SYMVER filemap_range_has_page 0x4e4225cd
#SYMVER filemap_fdatawait_range 0x2907cbf9
#SYMVER filemap_fdatawait_range_keep_errors 0x96e8566a
#SYMVER file_fdatawait_range 0x55527d2a
#SYMVER filemap_fdatawait_keep_errors 0x28672229
#SYMVER filemap_range_has_writeback 0x010b2e26
#SYMVER filemap_write_and_wait_range 0xb2647bbe
#SYMVER __filemap_set_wb_err 0x5dde313e
#SYMVER file_check_and_advance_wb_err 0x0c70d67b
#SYMVER file_write_and_wait_range 0x5976bd62
#SYMVER replace_page_cache_page 0x661875f4
#SYMVER filemap_add_folio 0x55e86c9c
#SYMVER filemap_invalidate_lock_two 0x6db2ccee
#SYMVER filemap_invalidate_unlock_two 0x13f22bf6
#SYMVER folio_wait_bit 0x710b9964
#SYMVER folio_wait_bit_killable 0xad901ff4
#SYMVER folio_add_wait_queue 0x670bd858
#SYMVER folio_unlock 0x42c3db4e
#SYMVER folio_end_private_2 0xa07a7595
#SYMVER folio_wait_private_2 0x5bf23e8c
#SYMVER folio_wait_private_2_killable 0xd9090c5e
#SYMVER folio_end_writeback 0x68883e5a
#SYMVER page_endio 0x5b7d9e78
#SYMVER __folio_lock 0x68d62b98
#SYMVER __folio_lock_killable 0x4f37a23e
#SYMVER page_cache_next_miss 0xe9d94d08
#SYMVER page_cache_prev_miss 0xbe8c4ee1
#SYMVER __filemap_get_folio 0x1b868cbc
#SYMVER filemap_get_folios 0xc4f3afc6
#SYMVER filemap_get_folios_contig 0x2f1b6668
#SYMVER find_get_pages_range_tag 0xf75564ac
#SYMVER filemap_read 0xa9e5d805
#SYMVER generic_file_read_iter 0xcad783e7
#SYMVER filemap_fault 0xd4e123e1
#SYMVER filemap_map_pages 0xbc09604e
#SYMVER filemap_page_mkwrite 0x8049cb42
#SYMVER generic_file_mmap 0xd9aff72d
#SYMVER generic_file_readonly_mmap 0x428f3a75
#SYMVER read_cache_folio 0x93202569
#SYMVER read_cache_page 0x6da75660
#SYMVER read_cache_page_gfp 0x8a4a4502
#SYMVER generic_file_direct_write 0xacc6fbde
#SYMVER generic_perform_write 0xa6662d4d
#SYMVER __generic_file_write_iter 0xd8efb3a6
#SYMVER generic_file_write_iter 0x2b51808f
#SYMVER filemap_release_folio 0x9ee9003f
