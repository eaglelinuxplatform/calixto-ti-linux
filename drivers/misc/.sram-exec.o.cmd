...
deps_drivers/misc/sram-exec.o := \
  ...
  drivers/misc/sram.h \
    $(wildcard include/config/SRAM_DMA_HEAP) \

drivers/misc/sram-exec.o: $(deps_drivers/misc/sram-exec.o)

$(deps_drivers/misc/sram-exec.o):
#SYMVER sram_exec_copy 0xfa03858a
