...
SYMBOL_CRC(usb_stor_host_template_init, 0xb437f4af, "_gpl");
SYMBOL_CRC(usb_stor_sense_invalidCDB, 0x1bc3edc2, "_gpl");
SYMBOL_CRC(usb_stor_access_xfer_buf, 0x5e80443d, "_gpl");
SYMBOL_CRC(usb_stor_set_xfer_buf, 0xa6d900aa, "_gpl");
SYMBOL_CRC(usb_stor_transparent_scsi_command, 0xf245ea21, "_gpl");
SYMBOL_CRC(usb_stor_Bulk_reset, 0xb0ee8487, "_gpl");
SYMBOL_CRC(usb_stor_Bulk_transport, 0x1f867c66, "_gpl");
SYMBOL_CRC(usb_stor_CB_reset, 0xcccd9404, "_gpl");
SYMBOL_CRC(usb_stor_CB_transport, 0x82eeff5b, "_gpl");
SYMBOL_CRC(usb_stor_bulk_srb, 0x797bf307, "_gpl");
SYMBOL_CRC(usb_stor_bulk_transfer_buf, 0xee41635a, "_gpl");
SYMBOL_CRC(usb_stor_bulk_transfer_sg, 0xdb5b84e6, "_gpl");
SYMBOL_CRC(usb_stor_clear_halt, 0x27ff99ed, "_gpl");
SYMBOL_CRC(usb_stor_control_msg, 0x42734655, "_gpl");
SYMBOL_CRC(usb_stor_ctrl_transfer, 0x9ce401e0, "_gpl");
SYMBOL_CRC(fill_inquiry_response, 0x9c75456b, "_gpl");
SYMBOL_CRC(usb_stor_adjust_quirks, 0x85f1f64a, "_gpl");
SYMBOL_CRC(usb_stor_disconnect, 0x27e73f7b, "_gpl");
SYMBOL_CRC(usb_stor_post_reset, 0x5ab85629, "_gpl");
SYMBOL_CRC(usb_stor_pre_reset, 0xb8afe3f5, "_gpl");
SYMBOL_CRC(usb_stor_probe1, 0x97752e33, "_gpl");
SYMBOL_CRC(usb_stor_probe2, 0x23d88eb5, "_gpl");
SYMBOL_CRC(usb_stor_reset_resume, 0xdf2e5773, "_gpl");
SYMBOL_CRC(usb_stor_resume, 0x3c1d5b68, "_gpl");
SYMBOL_CRC(usb_stor_suspend, 0xa31cf3f5, "_gpl");

static const struct modversion_info ____versions[]
__used __section("__versions") = {
	{ 0xd30a346c, "usb_alloc_urb" },
	{ 0x1b70dd17, "scsi_report_device_reset" },
	...
	{ 0x74d17f95, "scsi_remove_host" },
	{ 0xefd6cf06, "__aeabi_unwind_cpp_pr0" },
	{ 0x870d5a1c, "__init_swait_queue_head" },
	{ 0x49970de8, "finish_wait" },
	{ 0x52c9ee7b, "usb_register_driver" },
	{ 0xa0cb0a2f, "scsi_report_bus_reset" },
	...
	{ 0x53b000b9, "blk_queue_bounce_limit" },
	{ 0xa64a9908, "device_create_file" },
	{ 0xfe487975, "init_wait_entry" },
	{ 0xc322d103, "sg_miter_next" },
	{ 0xba3e8827, "_dev_err" },
	{ 0x5cf906c6, "blk_queue_update_dma_alignment" },
	{ 0x3a994b6c, "scsi_host_put" },
	{ 0x69859f69, "usb_free_coherent" },
	{ 0xd4034828, "system_freezable_wq" },
	{ 0x828ce6bb, "mutex_lock" },
	{ 0xaa250c63, "scsi_scan_host" },
	...
	{ 0xb5106111, "scsi_is_host_device" },
	{ 0x3ca20b7f, "scsi_eh_restore_cmnd" },
	...
	{ 0xbcedd639, "usb_reset_endpoint" },
	{ 0x1d8bb3c4, "scsi_done" },
	{ 0xbb6df778, "sg_nents" },
	{ 0xaa42a42f, "kmalloc_trace" },
	{ 0xd44064a2, "blk_queue_max_hw_sectors" },
	{ 0x288ac075, "scsi_add_host_with_dma" },
	{ 0x151f4898, "schedule_timeout_uninterruptible" },
	{ 0x97255bdf, "strlen" },
	{ 0xf5856c89, "usb_sg_wait" },
	{ 0x1b4ac7be, "scsi_done_direct" },
	{ 0xfbad3cf0, "scsi_normalize_sense" },
	{ 0x2c49f97, "scsi_host_alloc" },
	{ 0x62af7fa0, "sg_miter_skip" },
...
MODULE_INFO(srcversion, "332172CD9190462604B8FDB");
