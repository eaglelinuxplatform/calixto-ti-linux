...
$(deps_drivers/iommu/iommu.o):
#SYMVER iommu_device_register 0x55405c52
#SYMVER iommu_device_unregister 0xb2e950a0
...
#SYMVER iommu_group_add_device 0xcc647183
#SYMVER iommu_group_remove_device 0x1ba1a0e2
#SYMVER iommu_group_for_each_dev 0x2b7c407c
#SYMVER iommu_group_get 0x9a82a4b2
#SYMVER iommu_group_ref_get 0x4d6d0bbc
#SYMVER iommu_group_put 0x89485687
#SYMVER iommu_register_device_fault_handler 0x7b6879c8
#SYMVER iommu_unregister_device_fault_handler 0xaa73f3a2
#SYMVER iommu_report_device_fault 0xe58e3ea0
#SYMVER iommu_page_response 0x3c56a6ff
#SYMVER iommu_group_id 0x6e7943ec
#SYMVER generic_device_group 0xad5eb817
#SYMVER pci_device_group 0x03eba7f5
#SYMVER fsl_mc_device_group 0xe2599889
#SYMVER iommu_present 0x688fe1c6
#SYMVER device_iommu_capable 0xcd425e7c
#SYMVER iommu_set_fault_handler 0xe7c9c8b5
#SYMVER iommu_domain_alloc 0x55c85f66
#SYMVER iommu_domain_free 0xca9c3a38
#SYMVER iommu_attach_device 0x058b5f17
#SYMVER iommu_detach_device 0x0eb279b4
#SYMVER iommu_get_domain_for_dev 0xdfc41206
#SYMVER iommu_attach_group 0x9eedcee2
#SYMVER iommu_detach_group 0x64a51669
#SYMVER iommu_iova_to_phys 0xeefdbb22
#SYMVER iommu_map 0x0aaf88f5
#SYMVER iommu_map_atomic 0xc6fd67b4
#SYMVER iommu_unmap 0xaec0be96
#SYMVER iommu_unmap_fast 0x2ad54b36
#SYMVER iommu_map_sg 0x2298f679
#SYMVER report_iommu_fault 0x11be8a7f
#SYMVER iommu_enable_nesting 0x68515627
#SYMVER iommu_set_pgtable_quirks 0xa91a7e26
#SYMVER iommu_put_resv_regions 0x0ddaa41f
#SYMVER iommu_alloc_resv_region 0x3054bee9
#SYMVER iommu_default_passthrough 0xc3ea5305
#SYMVER iommu_fwspec_init 0xb979f523
#SYMVER iommu_fwspec_free 0x5ef6c51f
#SYMVER iommu_fwspec_add_ids 0x93978123
#SYMVER iommu_dev_enable_feature 0x1c19feaa
#SYMVER iommu_dev_disable_feature 0x5b43297a
#SYMVER iommu_sva_bind_device 0xf69b5c4f
#SYMVER iommu_sva_unbind_device 0x660c514e
#SYMVER iommu_sva_get_pasid 0xebeb8bbe
