...
$(deps_drivers/virtio/virtio_ring.o):
#SYMVER virtio_max_dma_size 0x3d99a040
#SYMVER virtqueue_add_sgs 0x1a7434ac
#SYMVER virtqueue_add_outbuf 0xd3c6b200
#SYMVER virtqueue_add_inbuf 0x17c23b0e
#SYMVER virtqueue_add_inbuf_ctx 0x366adb19
#SYMVER virtqueue_kick_prepare 0x19d013ba
#SYMVER virtqueue_notify 0xba242a47
#SYMVER virtqueue_kick 0xd0438443
#SYMVER virtqueue_get_buf_ctx 0x52576f79
#SYMVER virtqueue_get_buf 0x4540c256
#SYMVER virtqueue_disable_cb 0x1ac0f45c
#SYMVER virtqueue_enable_cb_prepare 0x8d8f9e09
#SYMVER virtqueue_poll 0xd2610dbb
#SYMVER virtqueue_enable_cb 0x70807b63
#SYMVER virtqueue_enable_cb_delayed 0x5eac1733
#SYMVER virtqueue_detach_unused_buf 0xbd0b0a12
#SYMVER vring_interrupt 0xff05fa13
#SYMVER vring_create_virtqueue 0xaeb4dbb5
#SYMVER virtqueue_resize 0x0ee4793a
#SYMVER vring_new_virtqueue 0x65cb8a2d
#SYMVER vring_del_virtqueue 0x60c9ed4b
#SYMVER vring_transport_features 0x07cd4c97
#SYMVER virtqueue_get_vring_size 0x000e14c0
#SYMVER __virtqueue_break 0xaba4f827
#SYMVER __virtqueue_unbreak 0xf9fea6ef
#SYMVER virtqueue_is_broken 0x3203acbd
#SYMVER virtio_break_device 0xc7c49466
#SYMVER __virtio_unbreak_device 0x5e7dee91
#SYMVER virtqueue_get_desc_addr 0xa520c2c2
#SYMVER virtqueue_get_avail_addr 0x888a2f86
#SYMVER virtqueue_get_used_addr 0x99b2f770
#SYMVER virtqueue_get_vring 0xf65682a2
