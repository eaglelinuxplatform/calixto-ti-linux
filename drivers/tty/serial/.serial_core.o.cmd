...
$(deps_drivers/tty/serial/serial_core.o):
#SYMVER uart_write_wakeup 0xdda2b6b4
#SYMVER uart_update_timeout 0x17a1de0d
#SYMVER uart_get_baud_rate 0xcd89cf73
#SYMVER uart_get_divisor 0x496d3c2c
#SYMVER uart_xchar_out 0x5b44c9db
#SYMVER uart_console_write 0x9d8da7e6
#SYMVER uart_parse_earlycon 0x33b46aa6
#SYMVER uart_parse_options 0x4f72a987
#SYMVER uart_set_options 0xdfadfe3d
#SYMVER uart_suspend_port 0x378a5dd0
#SYMVER uart_resume_port 0xd4b384a7
#SYMVER uart_register_driver 0xa681a577
#SYMVER uart_unregister_driver 0x30e15223
#SYMVER uart_console_device 0xd2151ffd
#SYMVER uart_add_one_port 0x3c8165f7
#SYMVER uart_remove_one_port 0x9ff9a724
#SYMVER uart_match_port 0x49e2a84e
#SYMVER uart_handle_dcd_change 0x5c50be3b
#SYMVER uart_handle_cts_change 0x1fb1926d
#SYMVER uart_insert_char 0xdcdef9a6
#SYMVER uart_try_toggle_sysrq 0x6bdc2cfb
#SYMVER uart_get_rs485_mode 0x49cf7340
